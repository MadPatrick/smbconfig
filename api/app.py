...
SMB_CONF_KEYS = frozenset([
    ...
    "read raw", "write raw", "max xmit",
    "change notify", "kernel change notify", "change notify timeout",
    "oplocks", "level2 oplocks", "kernel oplocks",
    "vfs objects", "map acl inherit", "store dos attributes",
    "log level", "max log size", "logging", "log file",
